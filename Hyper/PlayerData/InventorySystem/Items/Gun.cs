...
internal class Gun : Item
{
    ...
    {
        var q = Helpers.CreateQuaternionFromTwoVectors(
            System.Numerics.Vector3.UnitX, 
            Conversions.ToNumericsVector(scene.Camera.Front));
        var projectile = Projectile.CreateStandardProjectile(
            scene.SimulationManager.Simulation,
